...
public class AndroidAudioDevice
{
    ...
    {
    	Log.i("AndroidAudioDevice","findFormatFromChannels");
    	switch(numChannels) {
    ...
    {
    	Log.i("AndroidAudioDevice","constructor");
    ...
    public void flush()
    {
    	Log.i("AndroidAudioDevice","flushs");
        track.flush();
    }

    public void writeSamples(byte[] samples, int length) 
    {
    	Log.i("AndroidAudioDevice","writeSamples");
    	Log.i("samples byte = ", String.valueOf(samples.length));
